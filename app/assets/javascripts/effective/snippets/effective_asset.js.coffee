      ...
      elements: [
        {
          id: 'iframe-insert',
          type: 'html',
          html: "<div><p id='iframe-insert-loading' class='text-center'><br><br><br><br>Loading...</p><iframe class='effective_assets_iframe' style='width: 100%; height: 100%; min-height: 500px;' src='/effective/assets?only=nonimages'><p>Loading...</p></iframe></div>"
          onLoad: (evt) ->
